...
<!-- решение -->
Чай матча увеличивает устойчивость кожи к ультрафиолету в 1.8 раза благодаря EGCG {% include link.html href="http://holistic-bio.com/science/pdf/22.%20Skin%20Pharm%20Physio%202009.pdf" %}. Это разница между небольшим покраснением и серьёзным ожогом.
...
[Миф о чае матча (об этом не знаю даже продавцы чая)]({{ '/blog/mif-o-chae-matcha' | relative_url }})
...
{% include image.html class="i1x1" image="matcha_tea_flowbrew.jpg" alt="Церемониальный чай матча от Flow Brew" caption="Чай матча от Flow Brew" %}

## Где купить чай матча

Закажите японский церемониальный чай матча [в нашем магазине]({{ '/' | relative_url }}).

- вы получите бесплатный венчик для заварки чая с первой покупкой
- вам бесплатно доставят чай за 1 день по Спб и 2-4 дня по Москве
